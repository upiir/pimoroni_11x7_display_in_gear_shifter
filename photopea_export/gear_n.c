...
#ifndef LV_ATTRIBUTE_IMG_GEAR_N
#define LV_ATTRIBUTE_IMG_GEAR_N
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_GEAR_N uint8_t gear_n_map[] = {
