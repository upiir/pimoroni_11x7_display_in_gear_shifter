...
#ifndef LV_ATTRIBUTE_IMG_GEAR_2
#define LV_ATTRIBUTE_IMG_GEAR_2
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_GEAR_2 uint8_t gear_2_map[] = {
