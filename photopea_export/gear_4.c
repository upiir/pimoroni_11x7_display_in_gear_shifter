...
#ifndef LV_ATTRIBUTE_IMG_GEAR_4
#define LV_ATTRIBUTE_IMG_GEAR_4
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_GEAR_4 uint8_t gear_4_map[] = {
